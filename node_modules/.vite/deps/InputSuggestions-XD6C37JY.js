...
import "./chunk-PWP4D57X.js";
import "./chunk-7MCSUB2E.js";
import "./chunk-Y4O442SL.js";
import "./chunk-NPG2NGWT.js";
...
function InputSuggestionsTemplate(hooks) {
  ...
  return jsxs(ResponsivePopover_default, { class: this.classes.popover, hideArrow: true, preventFocusRestore: true, preventInitialFocus: true, placement: "Bottom", horizontalAlign: "Start", tabindex: -1, style: this.styles.suggestionsPopover, onOpen: this._afterOpenPicker, onClose: this._afterClosePicker, onScroll: this._scroll, open: this.open, opener: this, accessibleName: this._popupLabel, children: [this._isPhone && jsxs(Fragment, { children: [jsxs("div", { slot: "header", class: "ui5-responsive-popover-header", children: [jsxs("div", { class: "row", children: [jsx("span", { children: this._headerTitleText }), jsx(Button_default, { class: "ui5-responsive-popover-close-btn", icon: decline_default, design: "Transparent", onClick: this._closePicker })] }), jsx("div", { class: "row", children: jsx("div", { class: "input-root-phone native-input-wrapper", children: jsx(Input_default, { class: "ui5-input-inner-phone", type: this.inputType, value: this.value, showClearIcon: this.showClearIcon, placeholder: this.placeholder, onInput: this._handleInput, onChange: this._handleChange }) }) })] }), this.hasValueStateMessage && jsxs("div", { class: this.classes.popoverValueState, style: this.styles.suggestionPopoverHeader, children: [jsx(Icon_default, { class: "ui5-input-value-state-message-icon", name: valueStateMessageInputIcon == null ? void 0 : valueStateMessageInputIcon.call(this) }), this.open && (valueStateMessage == null ? void 0 : valueStateMessage.call(this))] })] }), !this._isPhone && this.hasValueStateMessage && jsxs("div", { slot: "header", class: {
    "ui5-responsive-popover-header": true,
    "ui5-responsive-popover-header--focused": this._isValueStateFocused,
    ...this.classes.popoverValueState
  }, style: this.styles.suggestionPopoverHeader, children: [jsx(Icon_default, { class: "ui5-input-value-state-message-icon", name: valueStateMessageInputIcon == null ? void 0 : valueStateMessageInputIcon.call(this) }), this.open && (valueStateMessage == null ? void 0 : valueStateMessage.call(this))] }), suggestionsList.call(this), this._isPhone && jsx("div", { slot: "footer", class: "ui5-responsive-popover-footer", children: jsx(Button_default, { design: "Transparent", onClick: this._closePicker, children: "OK" }) })] });
}
...
//# sourceMappingURL=InputSuggestions-XD6C37JY.js.map
